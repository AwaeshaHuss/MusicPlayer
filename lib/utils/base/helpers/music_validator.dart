...
class RegExpValidator {
  ...
  /// clearZero digit:
  static FilteringTextInputFormatter clearZero = FilteringTextInputFormatter.deny(RegExp(r'^0+'));
  static FilteringTextInputFormatter allowAllNumber =  FilteringTextInputFormatter.allow(RegExp('[0-9]'));
  ...
  static bool isContainsSpecialCharacter(String value) {
    bool isContainsSpecialCharacter = RegExp(r'[!@#$%^&*(),.?":{}|<>]').hasMatch(value);
